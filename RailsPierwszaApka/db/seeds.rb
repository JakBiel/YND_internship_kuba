...
Task.create("name"=>"Moje_imie_nr_47", "description"=>"Opis mojego taska nr 3", "due_date"=>"2020-04-19", "position"=>5, "done_status"=>true, "to_do_list_id"=>8)
Task.create("name"=>"Moje_imie_nr_48", "description"=>"Opis mojego taska nr 4", "due_date"=>"2020-05-23", "position"=>7, "done_status"=>false, "to_do_list_id"=>8)
Task.create("name"=>"Moje_imie_nr_49", "description"=>"Opis mojego taska nr 5", "due_date"=>"2020-11-07", "position"=>8, "done_status"=>false, "to_do_list_id"=>8)
Task.create("name"=>"Moje_imie_nr_50", "description"=>"Opis mojego taska nr 6", "due_date"=>"2020-12-08", "position"=>9, "done_status"=>true, "to_do_list_id"=>8)
